...
:Author: `Thomas A. Germer <https://www.nist.gov/people/thomas-germer>`_
:E-mail: thomas.germer@nist.gov
:Telephone: 301-975-2876
:Address:
   | `Sensor Science Division <http://www.nist.gov/pml/div685/index.cfm>`_
   | `National Institute of Standards Technology <http://www.nist.gov>`_
   | 100 Bureau Drive Stop 8443
   | Gaithersburg, MD 20899-8443
:Current Version: |version| (|today|)
...
====================
   | `Technical Information and Questions <https://www.nist.gov/people/thomas-germer>`_
   | `Sensor Science Division Home Page <http://www.nist.gov/pml/div685/index.cfm>`_
   | `Sensor Science Division Inquiries <mailto:fraser@nist.gov>`_
   | `Website Comments <https://www.nist.gov/people/thomas-germer>`_
